...
# Run fossci's test suite: Luam unit tests (tst/unit/*.lua, standalone
# scripts that exit non-zero on failure) plus bats integration/CGI tests
# (tst/integration/*.bats, exercising the real built binary end to end --
# see tst/integration/test_helper.bash). Mirrors luametry/brain-ex's own
# bld/test.sh + tst/*.bats conventions.
#
